...
bool CInterCHeck::LoadCheckParam(CHECKPARAM *checkparam, QString* str)
{
	...
	checkparam->i_MinGray_Band = _param[checkparam->c_CameraName][QString::fromLocal8Bit("Error_Ò©°åÈ±ÏÝ").toStdString()][QString::fromLocal8Bit("Ò©°å×îÐ¡»Ò¶È").toStdString()]["value"].as<int>();
	checkparam->i_MinArea_Band = _param[checkparam->c_CameraName][QString::fromLocal8Bit("Error_Ò©°åÈ±ÏÝ").toStdString()][QString::fromLocal8Bit("Ò©°å×îÐ¡Ãæ»ý").toStdString()]["value"].as<int>();
