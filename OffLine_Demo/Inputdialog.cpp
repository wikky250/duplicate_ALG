	...
	ui(new Ui::InputDialog)
{
	ui->setupUi(this);
	SHOWOSK();
	this->setWindowFlags(windowFlags() & ~Qt::WindowContextHelpButtonHint);//去除右上角问号
...
int InputDialog::showMsgBox(const char* titleStr, const char* contentStr, const char* button1Str, const char* button2Str)//全是中文
{
